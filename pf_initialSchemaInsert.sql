...
ALTER TABLE animal ADD CONSTRAINT chk_animal_deceased CHECK ( animal_deceased IN ( 'N', 'Y' ) );
...
ALTER TABLE animal ADD CONSTRAINT animaltype_animal_fk FOREIGN KEY ( atype_id ) REFERENCES animal_type ( atype_id );

ALTER TABLE animal ADD CONSTRAINT owner_animal_fk FOREIGN KEY ( owner_id ) REFERENCES owner ( owner_id );

ALTER TABLE vet ADD CONSTRAINT clinic_vet_fk FOREIGN KEY ( clinic_id ) REFERENCES clinic ( clinic_id );

ALTER TABLE vet ADD CONSTRAINT specialisation_vet_fk FOREIGN KEY ( spec_id ) REFERENCES specialisation ( spec_id );

ALTER TABLE clinic ADD CONSTRAINT vet_clinic_fk FOREIGN KEY ( vet_id ) REFERENCES vet ( vet_id );
...
INSERT INTO drug (
    ...
    101,
    'Amoxicillin',
    'Used for bacterial infections; 5 mg per kg twice daily',
    12
);
...
INSERT INTO drug (
    ...
    102,
    'Rabies Vaccine',
    'Routine rabies vaccination for pets',
    99.99
);
...
INSERT INTO drug (
    ...
    103,
    'Microchip',
    'Electronic microchip for pet identification',
    50
);
...
INSERT INTO drug (
    ...
    104,
    'Epinephrine',
    'Emergency treatment for allergic reactions; 0.1 mg per kg',
    70
);
...
INSERT INTO drug (
    ...
    105,
    'Ketamine',
    'Anesthetic used for surgeries; dosage depends on the pet''s weight',
    50
);
...
INSERT INTO drug (
    ...
    106,
    'Chlorhexidine',
    'Antiseptic for dental cleaning; use as directed',
    10
);
...
INSERT INTO drug (
    ...
    107,
    'Ivermectin',
    'Used for heartworm prevention; 0.1 mg per kg monthly',
    16
);
...
INSERT INTO drug (
    ...
    108,
    'Fipronil',
    'Topical treatment for fleas and ticks; apply once monthly',
    45
);
...
INSERT INTO drug (
    ...
    109,
    'Corticosteroids',
    'For skin allergies; dosage as prescribed',
    4.5
);
...
INSERT INTO drug (
    ...
    110,
    'Clotrimazole',
    'Ear infection treatment; apply inside ear as directed',
    30
);
...
INSERT INTO drug (
    ...
    'Supplements for overall health; one tablet daily',
    1.2
);
...
INSERT INTO drug (
    ...
    112,
    'Barium',
    'Contrast medium for X-rays; dosage per vet''s instructions',
    15
);
...
INSERT INTO drug (
    ...
    113,
    'Sonographic Gel',
    'Ultrasound gel; apply as needed for procedures',
    3
);
...
INSERT INTO drug (
    ...
    114,
    'Buprenorphine',
    'Analgesic for post-surgery pain relief; 0.01 mg per kg',
    14
);
...
INSERT INTO drug (
    ...
    115,
    'Chemotherapy Agents',
    'Chemotherapeutic agents for cancer treatment; as per oncologist''s regimen',
    50
);
...
INSERT INTO drug (
    ...
    116,
    'Heart Medications',
    'Cardiology meds; follow vet''s prescription',
    8
);
...
INSERT INTO drug (
    ...
    117,
    'Glucosamine',
    'For joint health in senior pets; 500 mg daily',
    1.5
);
...
INSERT INTO drug (
    ...
    'Vitamins for young pets; according to the age and weight',
    40
);
...
INSERT INTO drug (
    ...
    119,
    'Dietary Supplements',
    'Nutritional supplements; per dietary needs',
    1
);
...
INSERT INTO drug (
    ...
    'Medication to aid in behavioral training; dosage as instructed',
    80
);
...
INSERT INTO clinic (
    ...
    1,
    'East Melbourne Veterinary Center',
    '47 Blackburn Road, Burwood East VIC 3151',
    '0398123456',
    1001
);
...
INSERT INTO clinic (
    ...
    2,
    'Northern Suburbs Animal Hospital',
    '78 High St, Thornbury VIC 3071',
    '0390215478',
    1003
);
...
INSERT INTO clinic (
    ...
    '32 Bay Rd, Sandringham VIC 3191',
    '0398765433',
    1004
);
...
INSERT INTO clinic (
    ...
    4,
    'Glen Iris Vet Clinic',
    '1501 High St, Glen Iris VIC 3146',
    '0398123458',
    1002
);
...
INSERT INTO clinic (
    ...
    5,
    'Brighton East Pet Care',
    '123 Thomas St, Brighton East VIC 3187',
    '0398765412',
    1007
);
